(function (blink) {
	...
	var pearson_NL_demoStyle = function () {
			blink.theme.styles.basic.apply(this, arguments);
		},
		page = blink.currentPage;

	pearson_NL_demoStyle.prototype = {
		bodyClassName: 'content_type_clase_pearson_NL_demo',
		ckEditorStyles: {
			...
			styles: [
				...
				{ name: 'Desplegable', type: 'widget', widget: 'blink_dropdown', attributes: { 'class': 'pearson_NL_demo-dropdown' } },
				{ name: 'Desplegable 2', type: 'widget', widget: 'blink_dropdown', attributes: { 'class': 'pearson_NL_demo-dropdown-2' } },
		...
		formatCarouselindicators: function () {
			...
			$navbarBottom
				.attr('class', 'pearson_NL_demo-navbar')
		...
		animateNavbarOnScroll: function () {
			...
			var $navbar = $('.pearson_NL_demo-navbar');
			var lastScrollTop = 0;
			$('.js-slider-item').scroll(function () {
                ...
                changeHighBar: function () {
                    if($('.pearson_NL_demo-navbar').length>0 && $('.navbar').length>0){
                        blink.theme.setTopByHeight('.navbar', '.pearson_NL_demo-navbar');
                    }
                }
	};

	pearson_NL_demoStyle.prototype = _.extend({}, new blink.theme.styles.basic(), pearson_NL_demoStyle.prototype);

	blink.theme.styles['pearson_NL_demo'] = pearson_NL_demoStyle;
